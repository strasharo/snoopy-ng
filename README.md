...
This is targetted for installation on Raspbian Lite. Several changes (potentially severe) will be made to the environment. *DO NOT* install this on any device that contains data you care about.
