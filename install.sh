...
network={
  ...
  ln "/etc/wpa_supplicant/wpa_supplicant.conf" "./.supplicant.conf"
fi
...
apt-get --force-yes --yes install python-pip python-pypcap python-setuptools autossh python-psutil python2.7-dev libpcap0.8-dev ppp at tcpdump dnsutils\
  python-serial sqlite3 python-requests iw build-essential python-bluez python-flask python-gps python-dateutil python-dev libxml2-dev libxslt-dev pyrit git-core ethtool
